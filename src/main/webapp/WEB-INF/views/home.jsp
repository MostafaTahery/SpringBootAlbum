...
<span class="col-md-12"></span>
 <div class="container align-middle">
      ...
      <form class="form-signin col-sm-4 col-md-offset-2" action="<sp:url value="/home/"></sp:url>" method="post">
        ...
        <label for="inputPassword" class="sr-only">Password</label>
        <input type="password" id="inputPassword" name="pass2" class="form-control" placeholder="Retype Password" required>
        <label for="inputEmail" class="sr-only">Email</label>
        <input type="Email" id="inputEmail" name="Email" class="form-control" placeholder="Email" required autofocus>
        <label for="inputBirthdate" class="sr-only"  >Birth Date</label>
        <input type="date" id="inputPassword" name="BirthDate" class="form-control" placeholder="Birthdate" required>
